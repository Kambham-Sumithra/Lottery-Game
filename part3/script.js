...
/*
Math.floor() --> Rounds a number down to the nearest integer    4.7 - o/p --> 4
Math.ceil()  --> Rounds a number up to the nearest integer  4.7 - o/p -->5
Rounding  --> 4.3 - o/p --> 4 , 4.7 - o/p --> 5
*/